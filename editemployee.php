...
$update="update users set trn_date='".$trn_date."', name='".$name."', address='".$address."',city='".$city."', pincode='".$pincode."', mobileno='".$mobileno."', gender='".$gender."', emp_type='".$emp_type."', division='".$division."', email='".$email."', password='".$password."', submittedby='".$submittedby."' where id='".$id."'";
